...
namespace OOD_Project.Admin
{
    public partial class ViewFeedbackForm : Form
    {
        ...
        private void UpdateView()
        {
            ...
            lblA1.Text = $"Answer:\n{answers[feedback.Answers[0]]}";
            lblA2.Text = $"Answer:\n{answers[feedback.Answers[1]]}";
            lblA3.Text = $"Answer:\n{answers[feedback.Answers[2]]}";
            lblA4.Text = $"Answer:\n{answers[feedback.Answers[3]]}";
            lblA5.Text = $"Answer:\n{answers[feedback.Answers[4]]}";
        ...
        private void PopulateStudents()
        {
            ...
            dbm.Command.CommandText = "SELECT s.student_id, s.first_name, s.last_name\r\n" +
                "FROM [dbo].[student] s\r\n" +
                "JOIN [dbo].[registration] r ON c.student_id = s.student_id\r\n" +
